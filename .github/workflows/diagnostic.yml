...
def run():
    with sync_playwright() as p:
        ...
        page.wait_for_timeout(3000)  # JS'in tamamen yüklenmesi için bekle
        ...
        # Formla ilgili olabilecek tüm elemanları listele
        ...
        # Captcha olup olmadığını da kontrol edelim (kelime bazlı basit kontrol)
